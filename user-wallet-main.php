<?php
/**
 * Main User Wallet Credit System Class
 *
...
class WPUW {
	...
	public function register_scripts() {
		wp_register_script( 'wpvw_admin', plugins_url( '/assets/js/admin.js', __FILE__ ), array('jquery-ui-tabs'), '1.1' );
	}
