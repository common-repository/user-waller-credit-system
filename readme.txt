...
* Added in Admin toolbar wallet balance
* Added filters to allow for more plugin customization
* Added a balance widget to help with displaying the balance on the front end
* Added action "uwcs_balance_widget" to allow for additional content in the widget

= 3.1.0 =
*Release Date - Jan 10 2020*

* Fixed the shipping methods list
* Updated the plugin now uses methods instead of properties
* Fixed Wallet update error
* Fixed issue with wallet not showing on frontend during checkout.
